...
const moduleRoleMap = new Map<string, Set<string>>([
  ...
  ['stock-transfer-desk', new Set([ownerRole, managerRole, backOfficeRole])],
  ['grn-receiving', new Set([ownerRole, managerRole, backOfficeRole])],
  ['inward-register', new Set([ownerRole, managerRole, backOfficeRole])],
  ['gate-pass-control', new Set([ownerRole, managerRole, backOfficeRole])],
