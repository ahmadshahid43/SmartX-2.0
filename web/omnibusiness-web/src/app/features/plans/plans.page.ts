...
const PLAN_PRESETS: PlanPresetDefinition[] = [
  ...
  },
  {
    ...
    highlights: ['Counter control', 'Transfers + inward desk', 'Barcode suite', 'Operational reporting'],
  },
  {
    code: 'business',
    name: 'Business',
    ...
    highlights: ['FBR queue handling', 'Gate pass + warehouse ops', 'Returns and refunds', 'No-code setup'],
  },
  {
    code: 'premium',
    name: 'Premium',
    ...
    highlights: ['Installment payments', 'Warehouse + gate pass desk', 'Trade-in workflow', 'Social publishing'],
  },
];
