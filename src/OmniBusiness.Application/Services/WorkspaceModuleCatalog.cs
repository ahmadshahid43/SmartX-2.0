        ...
        new(
            ...
            [
                ...
                new(
                    "stock-transfer-desk",
                    "Stock Transfer Desk",
                    "Create inter-branch stock transfers, watch dispatch status, and control receiving priorities.",
                    "swap_horiz",
                    "/warehouse",
                    "Live Screen",
                    "Growth",
                    false,
                    true,
                    ["Inter-branch transfer creation", "Dispatch and receive status", "Transfer notes and ETAs"]),
                new(
                    "grn-receiving",
                    "GRN & Receiving",
                ...
                new(
                    "inward-register",
                    "Inward Register",
                    "Capture purchase inward entries with receipt notes, variance visibility, and warehouse-wise intake logs.",
                    "inbox",
                    "/warehouse",
                    "Live Screen",
                    "Growth",
                    false,
                    true,
                    ["Inward receipt capture", "Variance tracking", "Warehouse intake history"]),
                new(
                    "gate-pass-control",
                    "Gate Pass Control",
                    "Prepare dispatch and return gate passes with reference tracking for warehouse handover.",
                    "local_police",
                    "/warehouse",
                    "Live Screen",
                    "Business",
                    false,
                    true,
                    ["Dispatch gate pass issue", "Reference tracking", "Movement type control"]),
                new(
                    "warehouse-reports",
                    "Warehouse Reports",
