...
internal static class WorkspaceRoleAccess
{
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlySet<string>> ModuleRoleMap =
        new Dictionary<string, IReadOnlySet<string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["stock-transfer-desk"] = CreateRoleSet(OwnerRole, ManagerRole, BackOfficeRole),
            ["grn-receiving"] = CreateRoleSet(OwnerRole, ManagerRole, BackOfficeRole),
            ["inward-register"] = CreateRoleSet(OwnerRole, ManagerRole, BackOfficeRole),
            ["gate-pass-control"] = CreateRoleSet(OwnerRole, ManagerRole, BackOfficeRole),
